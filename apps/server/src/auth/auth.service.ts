import { MongoPrismaClient, PostgresPrismaClient } from '@cyber-sight/database';
import { TokenPayload, UserPayload, UserWithTokensDataPayload } from '@cyber-sight/shared';
import {
  BadRequestException,
  ConflictException,
  HttpException,
